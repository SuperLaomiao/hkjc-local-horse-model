...
- [x] Verify the first newly published 2026/27 local race card end to end: official fixture identity, runner rows, SQLite `upcoming` state, and the next due T-window.
  - Completed 2026-09-09: synced the official 10-race 2026-09-06 Sha Tin results and 8-race 2026-09-09 Happy Valley card into private SQLite, captured R1 T-30 WIN/PLA/QIN/QPL before post time, and verified the repaired ten-minute LaunchAgent completed two automatic cycles with exit 0.
