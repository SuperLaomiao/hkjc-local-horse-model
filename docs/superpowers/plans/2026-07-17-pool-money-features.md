...
- [ ] **Step 1: Write the failing WIN-book test**
...
- [ ] **Step 3: Implement the minimal coherent-book builder**
...
- [ ] **Step 1: Add failing QIN involvement test**
...
- [ ] **Step 3: Implement QIN/QPL pair involvement**
...
- [ ] **Step 4: Add failing tests for missing pools, future snapshots, coherent books, and movement**
...
- [ ] **Step 5: Implement missingness, exclusion, selection, and movement**
...
- [ ] **Step 1: Write a failing SQLite integration test**
...
- [ ] **Step 3: Implement the SQLite adapter and training merge**
...
- [ ] **Step 4: Prove missing pools keep training rows valid**
...
- [ ] **Step 1: Add the tested pool features to Python `FEATURES`**
...
- [ ] **Step 2: Export a real local training smoke file**
...
- [ ] **Step 3: Train a smoke model only if variable pool coverage exists**
...
- [ ] **Step 4: Update roadmap state and continuation note**
...
- [ ] **Step 2: Inspect generated paths and git diff**
